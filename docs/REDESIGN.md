...
- Typography revision: IBM Plex Mono for navigation, index titles, dates, code, and CVE article headings and prose. CVE descriptions use generous line spacing with genuine bold and italic faces. Regular blog posts retain Literata, with IBM Plex Sans for archive summaries. Self-host the selected fonts in the production site.
