...
int pickCharMinimal(float g){
  ...
  if (g>0.6) return 15252014;
  if (g>0.5) return 13121101;
  if (g>0.4) return 15255086;
...
const makeProgram = (gl, vsSrc, fsSrc) => {
...
export const AsciiNoiseEffect = ({ 
  ...
  brightness = 1,
  contrast = 1,
  seed1 = 6.289910009065847,
  seed2 = 1.1592377091798534,
  hue = 360,
  sat = 1,
  gamma = 1.15,
  vignette = 0,
